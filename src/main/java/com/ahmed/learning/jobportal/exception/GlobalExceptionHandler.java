...
@RestControllerAdvice(basePackages = "com.ahmed.learning.jobportal")
public class GlobalExceptionHandler {
	...
	ResponseEntity<Map<String, String>> handleException(MethodArgumentNotValidException exception
	) {
		...
		fieldErrorList.forEach(fieldError -> errors.put(fieldError.getField(),
